...
async function startR(){
    ...
    xcaa.sendMessage(anu.id, {audio: butff, ptt:true, contextInfo: { mentionedJid: [num], mimetype: "mp3/mp4", forwardingScore: 508, isForwarded: true, externalAdReply: {title: teks1, body: `${ddate}`, mediaType: "2", thumbnail: bufft, mediaUrl: global.linkgc}}})
    ...
    xcaa.sendMessage(anu.id, {audio: lvpantex, ptt:true, contextInfo: { mentionedJid: [num], mimetype: "mp3/mp4", forwardingScore: 508, isForwarded: true, externalAdReply: {title: teks2, body: `${ddate}`, mediaType: "2", thumbnail: lvbuft, mediaUrl: global.linkgc}}})
    }
    }
    } catch (err) {
      console.log(err)
